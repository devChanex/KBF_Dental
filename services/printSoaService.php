...
class ServiceClass
{
    ...
    public function printSoa($soaid)
    {
        try {
            ...
            <div class="row">
                    <div class="col-md-6">
                    Dentist :<strong onclick="createTicket(\''.$soaid.'\',\''.$row["dentist"].'\',\'dentist\',\'treatmentsoa\',\'soaid\');">' . $row["dentist"] . '</strong>
                           
                    </div>
                    <div class="col-md-6">
                            Date :<strong onclick="createTicket(\''.$soaid.'\',\''.$row["date"].'\',\'date\',\'treatmentsoa\',\'soaid\');">' . $row["date"] . '</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                    Time :<strong onclick="createTicket(\''.$soaid.'\',\''.$row["time"].'\',\'time\',\'treatmentsoa\',\'soaid\');">' . $row["time"] . '</strong>
