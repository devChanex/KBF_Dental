function addPatientPersonalInfo(){
    ...
    if (lastName == "") {
        ...
        if (guardianName == "") {
            ...
            submitform(lastName,firstName,middleName,nickName,gender,age,birthday,occupation,homeAddress,contactNumber,guardianName,guardianOccupation,referredBy);
...
function submitform(lastName,firstName,middleName,nickName,gender,age,birthday,occupation,homeAddress,contactNumber,guardianName,guardianOccupation,referredBy){
    var fd = new FormData();
