                    ...
                    <div class="card shadow mb-12">
                        ...
                        <div class="card-body" id="bodyResult" style="padding-left:20%;padding-right:20%;">
                            ...
                            <label for="Name">PERSONAL INFORMATION</label>
                                            ...
                                            <input type="date" name="birthday" id="birthday" class="form-control" placeholder="BIRTHDAY" onchange="computeAge()">
                                            ...
                                            <input type="Text" name="homeAddress" id="homeAddress" placeholder="HOME ADDRESS" class="form-control"><br>
                                            <label for="contactNumber">CONACT NUMBER</label>
                                            <input type="text" id="contactNumber" name="contactNumber" placeholder="CONTACT NUMBER" class="form-control"><br>
                                            <hr>
                                            <label for="for Minors">FOR MINOR'S ONLY</label>
                                            <hr>
                                            <label for="guardianName">GUARDIAN NAME</label>
                                            <input type="Text" name="guardianName" id="guardianName" placeholder="GUARDIAN NAME" class="form-control"><br>
                                            <label for="guardianOccupation">GUARDIAN OCCUPATION</label>
                                            <input type="Text" name="guardianOccupation" id="guardianOccupation" placeholder="GUARDIAN OCCUPATION" class="form-control"><br>
                                            <label for="referredBy">REFERRED BY</label>
                                            <input type="Text" name="referredBy" id="referredBy" placeholder="REFERRED BY" class="form-control"><br>
                                            <div id="formResult"></div>
                                            <button class="btn btn-success" onclick="addPatientPersonalInfo()">Submit</button>
