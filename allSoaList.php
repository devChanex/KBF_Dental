                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="sortableTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th onclick="sortTable(this)">SOA ID<span class="sort-icon"></span>
                                                </th>

                                                <th onclick="sortTable(this)">Full Name<span class="sort-icon"></span>
                                                </th>
                                                <th onclick="sortTable(this)">Dentist<span class="sort-icon"></span>
                                                </th>
                                                <th onclick="sortTable(this)">Treatment<span class="sort-icon"></span>
                                                </th>
                                                <th onclick="sortTable(this)">Price<span class="sort-icon"></span>
                                                </th>
